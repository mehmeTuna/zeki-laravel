...
<div style="width:100%;display:block;height:100%;">
  <header id="header" class="light">
      <div  style="width:80%;margin:0 auto;">
        <div class="container" >   
            <div class="row">
                <div class="col-md-10" style="padding-left:0;">
                    ...
                    <nav class="module module-navigation">
                        <ul id="nav-main" class="nav nav-main">  
                            <li class="nav-item" >
                                <router-link to="/home" >
                                    ...
                                    <div class="feature-icon icon icon-primary" style="font-size:30px">
                        ...
                        <!-- 
                            ...
                            <li v-else-if="userInfos.cardTotal === undefined" >
                                <a  href="/login" >
                                    <div class="feature-icon icon icon-primary" style="font-size:23px">
                                        <i class="ti ti-export"></i>
                                    </div>
                ...
                <div class="col-md-2" v-if="userInfos.cardTotal !== undefined">
    ...
    <header  id="header-mobile" class="dark" >
        ...
        <a  v-else-if="userInfos.cardTotal == undefined" @click="showPanel()" href="#" class="module module-cart"  data-toggle="panel-cart">
            <i class="ti ti-shopping-cart"></i>
            <span class="notification">0</span>
        </a>
