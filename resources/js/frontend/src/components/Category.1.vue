                            ...
                            <div :id="[index]" class="menu-category-content collapse  ">
                                ...
                                <div class="menu-item menu-list-item  " v-for="(menuItem) in product.menuItems" :key="menuItem.id">
                                    <div class="row align-items-center " >
                                        <div class="col-sm-2 ">
                        <img :src="menuItem.img" class="image-responsive text-center" alt="..." style="border-radius:50%" >

                                        </div>
                                        <div class="col-sm-7 mb-2 mb-sm-0 ">

                                            <h6 class="mb-0 text-danger text-lg">{{menuItem.name}}</h6>
                                            <span class="text-dark text-sm">{{menuItem.description}}</span>
                                           
                                        </div>
                                        <div   class="col-sm-3 text-sm-right"   >
                                          
                                            <span class="text-lg mr-4"><span class="text-muted"></span>{{menuItem.price}} ₺</span>                
                                           <button class="btn btn-outline-success btn-sm" href="#productModal" data-toggle="modal" @click="addProduct(menuItem)">Sepete Ekle</button>
                                            <!-- <button class="btn btn-outline-success btn-sm" data-target="#productModal"  @click="addProductToCart(menuItem)"><span>Sepete Ekle</span></button> -->
                                        </div>
                                    </div>
                                </div>
                                <!-- Menu Item -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-product-details">
                            ...
                            <!-- product.price*product.quantity Sepete bu şekilde gönderilecek -->
                                <div class="col-3 text-lg text-right">₺{{parseFloat(product.price)*parseInt(product.quantity)}}</div>
                            </div>
                        </div>
