        ...
        <div id="panel-cart"   :class="{ 'show' : menuShow }"  @click="menuShow = !menuShow" >
            <div class="panel-cart-container">
                ...
                <div class="panel-cart-content" v-if="userInfos.cardTotal !== undefined">
                 ...
                 <router-link to="/giris" class="btn btn-primary">><span>Giriş Yap</span></router-link>
            ...
            <div @click="$router.push('/alisverisitamamla')" class="panel-cart-action btn btn-secondary btn-block btn-lg">><span>Alışverişi Tamamla</span></div>
        </div>
        <!-- Body Overlay -->
