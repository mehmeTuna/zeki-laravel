            ...
            <div>
              <ul class="nav nav-main" style="display:flex;flex-wrap:wrap;">
                <li class="nav-item text-primary">
                  <router-link to="/iletisim" style="line-height:25px;" tag="a">İLETİŞİM</router-link>
                </li>
                <li class="nav-item text-primary hover">
                  <div @click="$router.push('/hizmetler')">HİZMETLER</div>
                </li>
                <li class="nav-item text-primary hover">
                  <div @click="$router.push('/rezervasyon')">REZERVASYON</div>
                </li>
                <li class="nav-item text-primary">
                  <div @click="$router.push('/hakkımızda')">HAKKIMIZDA</div>
                </li>
                <li class="nav-item text-primary hover">
                  <div @click="$router.push('/urunler')">MENÜ</div>
                </li>
                <li class="nav-item text-primary hover">
                  <div data-toggle="modal" data-target="#exampleModalCenter">KULLANICI SÖZLEŞMESİ</div>
                </li>
              </ul>
            </div>
            <div class="mt-4 mb-4">
              ...
              <a
                href="https://facebook.com/zekiustakebap"
                target="_blank"
                class="icon icon-social icon-circle icon-md icon-facebook mr-2"
              >
                <i class="fa fa-facebook"></i>
              </a>
              <a
                href="https://twitter.com/zekiustakebap"
                target="_blank"
                class="icon icon-social icon-circle icon-md icon-twitter mr-2"
              >
                <i class="fa fa-twitter"></i>
              </a>
              <a
                href="https://www.youtube.com/c/ZekiUstaKebap"
                target="_blank"
                class="icon icon-social icon-circle icon-md icon-youtube mr-2"
              >
                <i class="fa fa-youtube"></i>
              </a>
              <a
                href="https://www.instagram.com/zekiustakebap"
                target="_blank"
                class="icon icon-social icon-circle icon-md icon-instagram"
              >
