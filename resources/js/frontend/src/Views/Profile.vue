                ...
                <div class="tab-content p-b-3">
                                    ...
                                    <div class="card-body border--primary">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                >
                                                    <i
                                                        class="ti ti-user icon icon-primary"
                                                    ></i>
                                                    {{ userInfos.firstname }}
                                                    {{ userInfos.lastname }}
                                                </h3>
                                                ...
                                                >
                                                    <i
                                                        class="ti ti-mobile icon icon-primary"
                                                    ></i>
                                                    {{ userInfos.phone }}
                                                </p>
                                                <p
                                                ...
                                                >
                                                    <i
                                                        class="ti ti-location-pin icon icon-primary"
                                                    ></i>
                                                    {{
                    ...
                    <div class="tab-pane border--primary" id="kargotakip">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr
                                    v-for="(infos, index) in userOrderInfos"
                                    :key="infos.id"
                                >
                                    <td>{{ index }}</td>
                                    <td></td>
                    ...
                    <div class="tab-pane" id="adressEdit">
                        <div class="container col-md-12">
                            <div class="bg-white">
                                <h4 class="pb-4">
                                    <i
                                        class="ti ti-location-pin mr-3 text-primary"
                                    ></i
                                    >Adres Bilgileri
                                </h4>
                                <div class="row mb-5">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1"
                                        >Mahalle Seçiniz</label
                                    >

                                    <select
                                        class="form-control"
                                        v-model="adressUpdate.address"
                                    >
                                        <option
        ...
        sendNewInfo() {
            ...
            axios
                .post(url, {
                    ...
                    phone:
                        this.phone == ""
                            ? this.$store.state.products.phone
                            : this.phone,
                    email:
                        this.email == ""
