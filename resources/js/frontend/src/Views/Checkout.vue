                    ...
                    -->
                            ...
                            <div>
                                ...
                                >
                                    <div class="row">
                                        <div
                                            class="col-7 text-right text-muted"
                                        >
                                            Ara Toplam:
                                        </div>
                                        <div class="col-5">
                    ...
                    <div class="col-xl-8 pull-xl-4 col-lg-7 pull-lg-5">
                        <div class="bg-white p-4 p-md-5 mb-4">
                            <h4 class="border-bottom pb-4">
                                <i class="ti ti-user mr-3 text-dark"></i>Kişisel
                                Bilgiler
                            </h4>
                            <div class="row mb-5">
                                <!-- Paragraph -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4 class="border-bottom pb-4">
                                                    <i
                                                        class="ti ti-location-pin mr-3 text-dark"
                                                    ></i>
                                                    <span
                                                        class="text-primary"
                                                        >{{
                      ...
                      -->
                                        ...
                                        <div class="example-box-content">
                                            <h4 class="border-bottom pb-4">
                                                <i
                                                    class="ti ti-user mr-3 text-dark"
                                                ></i>
                                            ...
                                            <h4 class="border-bottom pb-4">
                                                <i
                                                    class="ti ti-mobile mr-3 text-dark"
                                                ></i>
                                                <span class="text-dark">{{
                                                    userInfos.phone
                                                }}</span>
                                            ...
                                            <h4 class="pb-4">
                                                <i
                                                    class="ti ti-location-arrow mr-3 text-dark"
                                                ></i>
                                                <span class="text-dark"
                                                    >Teslimat Adresini
                                                    Seçiniz</span
                            ...
                            <h4 class="border-bottom pb-4">
                                <i class="ti ti-package mr-3 text-primary"></i
                                >Teslim
                            </h4>
                            <div class="row mb-5">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="select-container">
                                        ...
                                        >
                                            ...
                                            >
                                            <option value="0"
                                                >Hemen (20-30 dakika)</option
                                            >
                                            <option value="1"
                                                >1 Saat içinde</option
                                            >
                                            <option value="2"
                                                >2 Saat içinde</option
                                            >
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label
                                        >Açık Adres Tarifi / Müşteri Yemek Notu
                                        :</label
                                    >
                                    <textarea
                                        class="form-control"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                -->
                                <form role="form">
                                    <div class="form-group">
                                        <label for="username"
                                            >Kartın Üzerindeki Tam Ad</label
                                        >
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <i
                                                        class="m-2 fa fa-3x fa-user"
                                                    ></i>
                                                </span>
                                            </div>
                                            <input
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <i
                                                        class="m-2 fa fa-2x fa-credit-card"
                                                    ></i>
                                                </span>
                                            </div>
                                            <input
