  ...
  <div class="main-panel">
    ...
    <div class="row">
      ...
      <div class="col-md-9 ml-4">
        ...
        <button @click="sortCategory" class="btn btn-fill btn-info">
          Sırala
        </button>
      </div>
    </div>
                      ...
                      <div class="modal-dialog " role="document">
                        <div class="modal-content" style="height:150%;width:150%">
                          ...
                          <div  class="form-group col-md-12 mt-4" >
                            ...
                            <input  placeholder="Yeni Kategori İsmi" class="form-control text-center  "  style="color:#606266" type="text" v-model="updateNewCategory.name">
                             </div>
                          ...
                          <input class="form-control" ref="file2" type="file" style="display:none" @change="onChangeUpdate($event)">
                          <button class="btn btn-outline-secondary" type="button" @click="$refs.file2.click()">Resim Seç</button>
                          </div>
...
export default {
  ...
  created() {
    ...
    const url2 =
      "https://next.json-generator.com/api/json/get/EJNFXxsPO";
