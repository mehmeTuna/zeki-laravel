          ...
          <div class="row">
            ...
            <div class="card card-user">
             <div class="card-body">
              ...
              <toggle-button  @change="updateRoles(0 , user.id)" :value='user.authority == 0 ? true : false'  color="#82C7EB" :sync="true"  :labels="true"/>
              ...
              <toggle-button  @change="updateRoles(1 ,user.id)" :value='(user.authority == 1 || user.authority == 2  ) ? true : false '  color="#82C7EB" :sync="true"  :labels="true"/>
              ...
              <toggle-button  @change="updateRoles(2 ,user.id )" :value='user.authority == 2 ? true : false '  color="#82C7EB" :sync="true"  :labels="true"/>
...
export default {
  data(){
    return{
        userList:[],
        yetkiList:[{"derece":"Okuma","number":1},{"derece":"Okuma-Yazma","number":2}],
        kullanici:{
        email:'',
        password:'',
        name:'',
        ...
        this.userList.map(
         function (userData) {
            if(userData.id == userId){
                if(value == 0 ){
                  authority = userData.authority = (userData.authority == value)  ? 1 : value;
                }else if(value == 1){
                  authority =  userData.authority = (userData.authority == value || userData.authority == 2 )  ? 0 : value  ;
                }else if(value == 2){
                 authority = userData.authority = (userData.authority == value)  ? 1 : value;
                }
            }
