        ...
        <div class="col-md-4">
          <div class="card card-chart">
            <div class="card-header">
              ...
              <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary"></i> {{kuryeToplamSiparis}} Adet</h3>
            </div>
            <div class="card-body">
              <div class="chart-area">
...
<script>
  ...
  export default {
   ...
   async mounted(){
     await axios.get('admin/api/iptalorder')
     .then((response) =>{
     ...
     await axios.get('admin/api/allKurye')
     .then((res) =>{
     ...
     await  axios.get('admin/api/thisdayorder')
        .then((response) => {
        ...
        await  axios.get('admin/api/thismonthorder')
        .then((response) => {
