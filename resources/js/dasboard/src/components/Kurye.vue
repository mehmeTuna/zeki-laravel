              ...
              <table class="table tablesorter" id>
                ...
                <tbody>
                  <tr v-for="kurye in kuryeList" :key="kurye.id">
                    <td>{{kurye.firstname}}</td>
                    <td>{{kurye.lastname}}</td>
                    <td>{{kurye.date}}</td>
                    <td class="text-center">{{kurye.siparis}}</td>
  ...
  methods: {
    sendDetail() {
      ...
      if (
        this.kurye.username != "" &&
        this.kurye.password != "" &&
        this.kurye.firstname != "" &&
        this.kurye.lastname != ""
      ) {
        axios.post(url, this.kurye).then(response => {
