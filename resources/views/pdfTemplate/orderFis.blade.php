...
<div style='font-size: 4mm;margin-top: 5mm;margin-bottom: 1mm;margin-left: 8mm'> <u>Ödenecek Toplam Tutar :
        {{$order_amount}} TL </u></div>
...
<div style='font-size: 4mm;left: 3mm;margin-top: 1mm'>Müşteri Notu: {{$icerik}}</div>
